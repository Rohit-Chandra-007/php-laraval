...
$desktopActive = "bg-gray-950/50 text-white";
$desktopInactive = "text-gray-300 hover:bg-white/5 hover:text-white";
$mobileActive = "bg-gray-950/50 text-white";
$mobileInactive = "text-gray-300 hover:bg-white/5 hover:text-white";
?>
<nav class="bg-gray-800/50">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="/" <?= $activePage === "/"
                            ? 'aria-current="page"'
                            : "" ?> class="rounded-md px-3 py-2 text-sm font-medium <?= $activePage === "/" ? $desktopActive : $desktopInactive ?>">Home</a>
                        <a href="/about" <?= $activePage === "/about"
                            ? 'aria-current="page"'
                            : "" ?> class="rounded-md px-3 py-2 text-sm font-medium <?= $activePage === "/about" ? $desktopActive : $desktopInactive ?>">About</a>
                        <a href="/contact" <?= $activePage ===
                        "/contact"
                            ? 'aria-current="page"'
                            : "" ?> class="rounded-md px-3 py-2 text-sm font-medium <?= $activePage === "/contact" ? $desktopActive : $desktopInactive ?>">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <a href="/" <?= $activePage === "/"
                ? 'aria-current="page"'
                : "" ?> class="block rounded-md px-3 py-2 text-base font-medium <?= $activePage === 
                "/" ? $mobileActive : $mobileInactive ?>">Home</a>
            <a href="/about.php" <?= $activePage === "/about.php"
                ? 'aria-current="page"'
                : "" ?> class="block rounded-md px-3 py-2 text-base font-medium <?= $activePage ==="/about.php" ? $mobileActive : $mobileInactive ?>">About</a>
            <a href="/contact.php" <?= $activePage === "/contact.php"
                ? 'aria-current="page"'
                : "" ?> class="block rounded-md px-3 py-2 text-base font-medium <?= $activePage === "/contact.php" ? $mobileActive : $mobileInactive ?>">Contact</a>
        </div>
